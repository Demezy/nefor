...
local CANNED_MAG_PROGRAM = table.concat({
  ...
  '             {:id "sx" :model (nefor.contracts.no-identifier)',
  '              :profile (nefor.contracts.identifier "standard") :provider "mock-plugin"',
  ...
  '(let sy (nefor.actors.agent',
  '           (as nefor.actors.AgentConfig',
  '             {:id "sy" :model (nefor.contracts.no-identifier)',
  '              :profile (nefor.contracts.identifier "standard") :provider "mock-plugin"',
  '              :system "Summarise lighthouses in one sentence." :tools []',
  '              :da-policy (nefor.contracts.no-da-policy)',
  '              :max-corrections 2})',
  '           (type-tag (| OctopusSummary nefor.contracts.AgentError))',
  '           (type-tag LighthouseSummary)))',
  '(let combine (nefor.actors.agent',
  '                (as nefor.actors.AgentConfig',
  '                  {:id "combine" :model (nefor.contracts.no-identifier)',
  '                   :profile (nefor.contracts.identifier "standard") :provider "mock-plugin"',
  '                   :system "Combine the two summaries above into one paragraph."',
  '                   :tools [] :da-policy (nefor.contracts.no-da-policy)',
  '                   :max-corrections 2})',
  '                (type-tag (| LighthouseSummary nefor.contracts.AgentError))',
