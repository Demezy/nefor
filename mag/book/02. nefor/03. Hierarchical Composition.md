...
example implements this shape. `nefor.agents.dynamic_with_tools` produces the
dynamic producer effect, `nefor.agents.dynamic_template_with_tools` defines the
