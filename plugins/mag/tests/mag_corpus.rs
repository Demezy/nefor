...
let start = nefor.graph.source("start", type_tag<core.types.Either<LeftValue, RightValue>>(), named(core.types.Either<LeftValue, RightValue>, Left, LeftValue {value: "left"}))
