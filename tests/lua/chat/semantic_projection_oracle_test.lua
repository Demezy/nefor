...
local function fixture()
  ...
  append("tool_call_completed", { exchange_id = "exchange-1", turn_id = "turn-1", call = { id = "provider-1", name = "mag", arguments = { action = "apply" } } })
  ...
  append("tool_call_completed", { exchange_id = "exchange-2", turn_id = "turn-1", call = { id = "provider-2", name = "mag", arguments = { action = "apply" } } })
