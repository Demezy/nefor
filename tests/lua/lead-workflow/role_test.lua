...
assert_contains(lead, "call `mag-await` once", "lead performs one attached wait after detachment")
...
assert_contains(lead, "Never poll `mag-status`", "lead forbids status polling")
